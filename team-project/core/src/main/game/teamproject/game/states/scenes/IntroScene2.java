...
public class IntroScene2 extends State {
    ...
    public IntroScene2(GameStateManager gsm) {
        super(gsm);
        ...
        label = new Label(" You have just found a rock made of \n" + " mankind’s rarest material; unobtanium. ", new Label.LabelStyle(white, Color.WHITE));
        label2 = new Label(" This material is invaluable to the right buyer.", new Label.LabelStyle(white, Color.WHITE));
        label3 = new Label(" It has the properties to enhance humans and \n" + " potentially save humanity. ", new Label.LabelStyle(white, Color.WHITE));
