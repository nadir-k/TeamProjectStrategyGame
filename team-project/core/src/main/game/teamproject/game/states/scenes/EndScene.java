...
public class EndScene extends State {
    ...
    public EndScene(GameStateManager gsm) {
        ...
        bgTex = new Texture(Gdx.files.internal("Scenes/lab.jpg"));
        background = new Image(bgTex);
        white = new BitmapFont(Gdx.files.internal("Font/white.fnt"), false);

        label = new Label("Gemini had tricked Anya. \n" + "They just wanted these stones for money. ", new Label.LabelStyle(white, Color.WHITE));
        label2 = new Label("Not to fund for something to prevent extinction. ", new Label.LabelStyle(white, Color.WHITE));
        label3 = new Label("But for the evolution of something worse. ", new Label.LabelStyle(white, Color.WHITE));
